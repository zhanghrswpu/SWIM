...
def get_args():
    ...
    parser.add_argument('--alg', type=str, default='swim',
                        help='communication strategy: swim')
    parser.add_argument('--comm_round', type=int, default=100, help='number of maximum communication roun')
    parser.add_argument('--kr', type=float, default=0.4, help='Choose the ratio of k (default: 0.4)')
    ...
    parser.add_argument('--mu', type=float, default=1, help='the mu parameter for fedprox or swim')
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (x, target) in enumerate(train_dataloader):
            ...
            for previous_net in previous_nets:
                ...
                # nega = cos(pro1, pro3)
                Z_prev[cnt % C] = pro3
                # nega=cos(pro1, pro1)-cos(pro1, pro1)
                for i in range(0, C):
                    if Z_prev[i] != None:
            ...
            epoch_loss2_collector.append(loss1.item())
